  ...
  <div>
      ...
      <v-expansion-panel>
        <v-expansion-panel-content>
          <div slot="header">
            <svg id="search-dna-symbol" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 48 48" style="enable-background:new 0 0 48.26 48.259;" xml:space="preserve" transform="translate(0, 7)" fill="#4b009e">
              <g>
        ...
        <v-expansion-panel-content>
          <div slot="header"><v-icon color="blue darken-2">view_list</v-icon>&nbsp; &nbsp;Panels</div>
          <v-card>
            <v-card-text>
              <!-- <span>
